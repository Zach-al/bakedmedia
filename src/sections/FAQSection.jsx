...
export const FAQSection = () => {
  ...
  return (
    <section 
      ref={containerRef} 
      style={{ 
        height: '300vh', // Large height to allow for vertical scrolling
    ...
    >
      <div style={{
        ...
        >
          ...
          {/* Card 3 */}
          <div className="philosophy-card" style={{ backgroundColor: 'var(--color-ink)', color: 'var(--color-paper)' }}>
            <div>
              <span style={{ fontFamily: 'var(--font-headline)', fontSize: '4rem', fontWeight: 900, color: 'var(--color-paper)', lineHeight: 1 }}>03</span>
            ...
            <p style={{ fontFamily: 'var(--font-sans)', fontSize: '1.1rem', fontWeight: 500, lineHeight: 1.6, color: 'rgba(255,255,255,0.8)' }}>
